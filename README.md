...
- `Pandas` , `Matplotlib` , `Plotly` 등의 파이썬 라이브러리를 이용해 데이터 분석 및 시각화 진행
  ...
  - 가수 분포
    ...
    <img src="https://user-images.githubusercontent.com/87269113/155986191-e9fe179b-6c58-4588-9a50-703fc4abb9db.png" width='60%' />
  
  - 제목 길이 분석
  
    > [제목 길이 분석 코드](./02.Data_Analysis_Visualization/04.Data_Analysis_Visualization_title.ipynb)
  
    <img src="https://user-images.githubusercontent.com/87269113/155986497-aaee214e-a4ff-406a-9627-7b4bfd3c88a3.png" width='60%'>
